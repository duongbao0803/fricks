    ...
    <div className="container mx-auto border border-gray-300 bg-white p-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div>
          <Image
            ...
            quality={100}
            alt="sản phẩm"
            className={`h-auto w-full rounded-lg transition-opacity duration-300 ${fadeIn ? "opacity-0" : "opacity-100"}`}
          />
        </div>

        <div>
          <h2 className="text-3xl font-semibold text-gray-700">Ống Nước</h2>
          <div className="mt-2 flex items-center space-x-2">
            ...
            <p className="text-sm text-gray-500">
              Thương hiệu: <span className="text-red-500">Bình Minh</span>
            </p>
          </div>
          <p className="mt-2 text-2xl font-bold text-red-500">750,000 đ</p>
          ...
          <div className="mt-6 rounded-md border border-gray-500 p-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-gray-600">
                <span className="mr-2">&#128663;</span> Miễn phí vận chuyển (Nội
                thành HCM)
              </li>
              <li className="flex items-center text-gray-600">
                <span className="mr-2">&#8635;</span> Hoàn trả miễn phí (Trong
                vòng 24h)
              </li>
              <li className="flex items-center text-gray-600">
      ...
      <div className="mt-8">
        ...
        <div className="text-gray-700">
          <h4 className="mb-2 font-semibold">Ống nước</h4>
          <p className="mb-2">Ống nước Bình Minh</p>
          <p className="mb-2">Ống nước Bình Minh</p>
        </div>
      </div>
            ...
            <div key={i} className="rounded-lg border border-gray-200 p-4">
              <div className="relative">
                ...
                <Image
                  ...
                  width={300}
                  quality={100}
                  src="/path/to/material-image.jpg"
              ...
              <p className="mt-1 text-gray-500">$120.00</p>
